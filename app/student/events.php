...
<body>
        ...
        <div class="nav-actions">
            ...
            <?php if ($is_logged): ?>
                <div class="nav-user-dropdown">
                    <?php 
                        $navPhoto = '';
                        $rawPhoto = $student['profile_photo'] ?? $student['ProfilePhoto'] ?? '';
                    ...
                    <button type="button" class="nav-profile nav-profile-trigger" aria-label="Open account menu">
                        <div class="nav-avatar">
                            ...
                            <?php if ($navPhoto !== ''): ?>
                                <img src="<?= htmlspecialchars($navPhoto) ?>" alt="Avatar" onerror="this.remove();">
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="nav-dropdown-menu" role="menu" aria-label="Account menu">
                        ...
                        <a href="../../config/API/endpoints/index.php?action=student_logout" class="nav-dropdown-item danger" role="menuitem"><ion-icon name="log-out-outline"></ion-icon><span>Logout</span></a>
                    </div>
                </div>
            <?php else: ?>
    ...
    <div class="nav-mobile">
        <ul>
            ...
            <li><a href="events.php" class="active"><i class='bx bx-calendar-event'></i> Events</a></li>
            <?php if ($is_logged): ?>
                ...
                <li>
                    <a href="announcements.php"><i class='bx bx-bell'></i> Announcements</a>
                </li>
                <li>
